...
public class PreferencesUtils {
     ...
     * 普通字段存放地址
     */
    public static String GETUICHAR = "getui";

    public static String getSharePreString(Context mContext,String field) {
        SharedPreferences sp = (SharedPreferences) mContext.getSharedPreferences(GETUICHAR, 0);
    ...
    public static void putSharePreString(Context mContext, String field, String value) {
        SharedPreferences sp = (SharedPreferences) mContext.getSharedPreferences(GETUICHAR, 0);
        sp.edit().putString(field, value).commit();
    }

    //保存int类型的value到whichSp中的field字段
    public static void putSharePreInt(Context mContext, String field, int value) {
        SharedPreferences sp = (SharedPreferences) mContext.getSharedPreferences(GETUICHAR, 0);
        sp.edit().putInt(field, value).commit();
    }

    //保存boolean类型的value到whichSp中的field字段
    public static void putSharePreBoolean(Context mContext, String field, Boolean value) {
        SharedPreferences sp = (SharedPreferences) mContext.getSharedPreferences(GETUICHAR, 0);
